...
Digunakan oleh Report Service untuk komunikasi dengan Auth Service.
"""
import time
import logging
...
class CircuitBreaker:
    ...
    States:
    - CLOSED:    Normal. Requests diteruskan ke Auth Service.
    ...
    def can_execute(self) -> bool:
        """Periksa apakah request boleh diteruskan ke Auth Service."""
        ...
        # HALF_OPEN — izinkan 1 request untuk test recovery
        return True

    def record_success(self):
        """Catat keberhasilan request ke Auth Service."""
    ...
    def record_failure(self):
        """Catat kegagalan request ke Auth Service."""
    ...
    def get_status(self) -> dict:
        """Return status circuit breaker untuk health check endpoint."""
        return {
            "name": self.name,
            "state": self.state,
